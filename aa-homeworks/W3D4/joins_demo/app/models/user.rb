class User < ApplicationRecord
  ...
  has_many :posts, :foreign_key => :author_id   # FIND ALL THE POSTS WHERE THIS USER IS AN AUTHOR
  # SELECT *
  #   FROM posts
  #  WHERE posts.author_id = #{self.id}
  has_many :comments, :foreign_key => :author_id # FROM THE USERS TABLE, FIND ALL THE COMMENTS THAT MATCH THIS USER ID
  # SELECT *
  #   FROM comments
  ...
  has_many :post_feedback, :through => :posts, :source => :comments # FIND ALL THE COMMENTS FOR ALL THE POSTS THIS USER HAS MADE
